...
Map B illustrates significant spatial patterns indicating areas of high and low bus trip concentration with a confidence level of 95%. Low-Low clusters suggest regions with consistently low bus trip demand. High-Low points indicates busy stops not surrounded by high-demand areas suggesting isolated transit hubs and the absence of Low-High clusters and the presence of High-High points reflect central zones with heavy bus usage.