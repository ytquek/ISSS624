...
attr_flow <- left_join(attr_flow, wdmp, by = c("ori_grid", "dest_grid"))
...
```
### Visualising correlation between attractive factors and trips
...
The Scatterplots above reveal that there seems to be a positive correlation between:

- Number of schools and number of trips
- Number of financial services and number of trips
- Numbers of HDB houses and number of trips
 while MRT exits doesnt seem to have a noticeable trend.
